class SparkAreaWidget extends WidgetBase {
    ...
    init() {
        ...
        const getSvg = this._getSvgAreaLine_2(
            ...
            areaColor,
            areaColor,
            "line-ubE231HdRlayTlCeh-eymw-seg0-c-svg",
            "",
            "",
            0.5,
            areaColor,
        ...
        segmentPanel.innerHTML = `
                ...
                <div class="widgetPanel_metric widgetPanel_sparkArea">
                 ${getSvg.outerHTML}                 
                 <div class="widgetPanel_sparkArea_minMax">
                     <div class="widgetPanel_sparkArea_minMax_max">1</div>
                     <div class="widgetPanel_sparkArea_minMax_half">0.5</div>
                     <div class="widgetPanel_sparkArea_minMax_min">0</div>                 
                 </div>
        ...
        set(segmentPanel.querySelector(".widgetPanel_sparkArea_minMax"), { color: this._getPanelTextColor() });
        set(segmentPanel.querySelector(".widgetPanel_sparkArea_minMax_max"), { text: [segment.prefix, this._getDecimals(maxValue), segment.suffix].join("") });
        set(segmentPanel.querySelector(".widgetPanel_sparkArea_minMax_half"), { text: [segment.prefix, this._getDecimals(maxValue / 2), segment.suffix].join("") });
    ...
    _getSvgAreaLine_2(
        ...
        this._addSparkArea(svg, idSvg, areaPoints, smoothing, areaDataColor, areaDataColor, "1");

        return svg;
    }

    _addSparkArea(svg, idSvg, points, smoothing, topStopColor, bottomStopColor, uniqueAreaID) {
